...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/veenu-satheesan/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@veenu_sathees",
    icon: Instagram,
    url: "https://www.instagram.com/veenu_sathees/profilecard/?igsh=MW1pdjJoNHBqZXEzYg==",
    color: "#E4405F",
  ...
  },
  {
    name: "Mail",
    displayName: "Mail",
    subText: "veenusatheesan@gmail.com",
    icon: Mail,
    url: "mailto:veenusatheesan@gmail.com",
    color: "#EA4335",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@VEENUSATHEESAN",
    icon: Github,
    url: "https://github.com/VEENUSATHEESAN",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [instagram, mail, github] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Second Row - Instagram & Mail */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, mail].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
